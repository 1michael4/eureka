...
public class ServicesItem implements IServicesItem{
	...
	public List<Items> findAll() {
		List<Producto> productos = Arrays.asList(clienteRest.getForObject("http://localhost:50837/api/productos", Producto[].class));
	...
	public Items findById(Long id, Integer cantidad) {
		...
		Producto producto = clienteRest.getForObject("http://localhost:50837/api/productos/{id}", Producto.class, pathVariables);
